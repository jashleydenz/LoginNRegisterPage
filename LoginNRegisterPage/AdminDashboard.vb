...
Public Class AdminDashboard
    ...
    Private Sub Form3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        AddHandler CloseWindow2.Click, AddressOf CloseWindow2_Click
        AddHandler MinimizedWindow2.Click, AddressOf MinimizedWindow2_Click

        ' Add hover effect event handlers
        AddHandler CloseWindow2.MouseEnter, AddressOf CloseWindow2_MouseEnter
        AddHandler CloseWindow2.MouseLeave, AddressOf CloseWindow2_MouseLeave
        AddHandler MinimizedWindow2.MouseEnter, AddressOf MinimizedWindow2_MouseEnter
        AddHandler MinimizedWindow2.MouseLeave, AddressOf MinimizedWindow2_MouseLeave
        AddHandler MaximizeWindow2.MouseEnter, AddressOf MaximizeWindow2_MouseEnter
        AddHandler MaximizeWindow2.MouseLeave, AddressOf MaximizeWindow2_MouseLeave
    ...
    Private Sub CloseWindow2_Click(sender As Object, e As EventArgs)
        Application.Exit()
    End Sub

    ' Event handlers for CloseWindow1 hover effects
    Private Sub CloseWindow2_MouseEnter(sender As Object, e As EventArgs)
        CType(sender, PictureBox).Cursor = Cursors.Hand  ' Change cursor to hand on hover
    End Sub

    Private Sub CloseWindow2_MouseLeave(sender As Object, e As EventArgs)
        CType(sender, PictureBox).Cursor = Cursors.Default  ' Revert cursor to default
    End Sub

    ' Event handler for minimize button click
    Private Sub MinimizedWindow2_Click(sender As Object, e As EventArgs)
        Me.WindowState = FormWindowState.Minimized
    End Sub

    ' Event handlers for MinimizedWindow1 hover effects
    Private Sub MinimizedWindow2_MouseEnter(sender As Object, e As EventArgs)
        CType(sender, PictureBox).Cursor = Cursors.Hand  ' Change cursor to hand on hover
    End Sub

    Private Sub MinimizedWindow2_MouseLeave(sender As Object, e As EventArgs)
        CType(sender, PictureBox).Cursor = Cursors.Default  ' Revert cursor to default
    End Sub

    Private Sub MaximizeWindow2_MouseEnter(sender As Object, e As EventArgs)
        CType(sender, PictureBox).Cursor = Cursors.Hand  ' Change cursor to hand on hover
    End Sub

    Private Sub MaximizeWindow2_MouseLeave(sender As Object, e As EventArgs)
        CType(sender, PictureBox).Cursor = Cursors.Default  ' Revert cursor to default
    End Sub
    ...
    Private Sub MaximizeWindow2_Click(sender As Object, e As EventArgs) Handles MaximizeWindow2.Click
    ...
    Private Sub btnManageUsers1_Click(sender As Object, e As EventArgs) Handles btnManageUsers1.Click
        FormManageUsers.Show()
        Me.Hide()
    End Sub

    Private Sub btnLogout1_Click(sender As Object, e As EventArgs) Handles btnLogout1.Click
        LoginPage.Show()
        Me.Close()
    End Sub
